...
export default class GamePlay {
  ...
  drawUi(theme) {
    ...
    this.gameLevelEl = this.container.querySelector('.game-level');
    this.totalScoreEl = this.container.querySelector('.total-score');
  ...
  updateStatisticPanels(gameLevel, totalScore, maxScore) {
    this.gameLevelEl.textContent = gameLevel;
